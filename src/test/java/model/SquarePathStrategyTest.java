 ...
 *  5) 3-모서리(index 15)를 “스킵해서 도달” → PathType == FROM15
 *  6) 3-모서리 이후 +3칸(index 18) → PathType 여전히 FROM15
...
class SquarePathStrategyTest {
    ...
    void firstCorner() {
        ...
        assertEquals(PathType.FROM5, b.piece.getPathType());    // :contentReference[oaicite:0]{index=0}
    }
    ...
    void firstCornerCenter() {
        ...
        assertEquals(PathType.FROM5CENTER, b.piece.getPathType()); // :contentReference[oaicite:1]{index=1}
    }
    ...
    void secondCorner() {
        ...
        assertEquals(PathType.FROM10, b.piece.getPathType());   // :contentReference[oaicite:2]{index=2}
    }
